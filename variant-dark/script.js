/**
 * Ember & Roots Wellness - Dark Variant
...
function initNavigation() {
    ...
    window.addEventListener('scroll', () => {
        if (window.scrollY > 100) {
            nav.style.background = 'rgba(13, 11, 9, 0.98)';
            nav.style.borderBottom = '1px solid rgba(232, 168, 92, 0.15)';
        } else {
            nav.style.background = 'linear-gradient(to bottom, rgba(13, 11, 9, 0.95), rgba(13, 11, 9, 0.8))';
            nav.style.borderBottom = '1px solid rgba(232, 168, 92, 0.08)';
        }
    });
